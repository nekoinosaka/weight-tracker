...
const Layout = ({ children }) => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      <AppBar position="static" elevation={0} sx={{ background: 'linear-gradient(90deg, #2196f3 0%, #64b5f6 100%)' }}>
      ...
      <Container component="main" sx={{ flexGrow: 1, py: 3, px: { xs: 1, sm: 2, md: 3 } }}>
        {children}
      </Container>
    </Box>
  );
